<template>
  <section class="ranking">
    <header class="ranking__header">
      ...
      <p class="ranking__header-el">Rank</p>
    ...
    <section class="ranking__content">
      <div class="ranking__bar" v-for="(player, idx) in list" :key="idx">
        ...
        <p class="ranking__bar-el">
          <img
            class="ranking__bar-rang"
            v-tooltip.left="`${player.stats[roomId].rank}`"
            :src="require(`../assets/images/${player.stats[roomId].rank}.svg`)"
            alt="Gold"
          />
        </p>
